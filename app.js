...
const hardware = [
  ...
  { id: 'lite', label: 'Specter Shield Lite', image: 'shield-lite-shop.webp', imageAlt: 'Specter DIY shop photograph (visual reference)', de: 'Kunststoffgehäuse mit Smartcard', en: 'Plastic case with smartcard' },
